...
if (!text) throw `${mg} 𝐭𝐚𝐠𝐠𝐚 𝐮𝐧𝐚 𝐩𝐞𝐫𝐬𝐨𝐧𝐚 𝐨 𝐬𝐜𝐫𝐢𝐯𝐢 𝐢𝐥 𝐧𝐨𝐦𝐞 𝐝𝐞𝐥 𝐞𝐥𝐞𝐦𝐞𝐧𝐭𝐨 𝐝𝐞𝐬𝐢𝐝𝐞𝐫𝐚𝐭𝐨
𝐩𝐞𝐫 𝐞𝐬𝐞𝐦𝐩𝐢𝐨: : .gay @64276665888 «» .gay vare` 

if (command == 'gay') {
let juego = `_*${text.toUpperCase()}* 𝐞̀ *${(150).getRandom()}%* 𝐟𝐫𝐨𝐜𝐢𝐨 🏳️‍🌈`.trim()
  
conn.sendHydrated(m.chat, juego, wm, null, ig, '𝐯𝐚𝐫𝐞 𝐛𝐨𝐭', null, null, [
['𝐜𝐨𝐧𝐟𝐞𝐫𝐦𝐨'],
['𝐧𝐞𝐠𝐫𝐨'],
['𝐟𝐚𝐤𝐞, 𝐧𝐚𝐥𝐭𝐫𝐚 𝐯𝐨𝐥𝐭𝐚', `${usedPrefix + command} ${text.toUpperCase()}`],
], m, m.mentionedJid ? {
...
if (command == 'lesbiana') { 
let juego = `_*${text.toUpperCase()}* 𝐞̀ *${(150).getRandom()}%* *${command.replace('how', '').toUpperCase()}*_ 🏳️‍🌈`.trim()

conn.sendHydrated(m.chat, juego, wm, null, md, '𝐯𝐚𝐫𝐞 𝐛𝐨𝐭', null, null, [
...
conn.sendHydrated(m.chat, juego, wm, null, md, '𝙑𝘼𝙍𝙀 𝘽𝙊𝙏', null, null, [
['𝙈𝙚𝙣𝙪 𝙅𝙪𝙚𝙜𝙤𝙨 | 𝙂𝙖𝙢𝙚𝙨 𝙈𝙚𝙣𝙪 🎡', '#juegosmenu'],
['𝙊𝙩𝙧𝙖 𝙫𝙚𝙯 | 𝘼𝙜𝙖𝙞𝙣 🤭', `${usedPrefix + command} ${text.toUpperCase()}`],
['𝙑𝙤𝙡𝙫𝙚𝙧 𝙖𝙡 𝙈𝙚𝙣𝙪́ | 𝘽𝙖𝙘𝙠 𝙩𝙤 𝙈𝙚𝙣𝙪 ☘️', '/menu']
], m, m.mentionedJid ? {
